...
export const OfflineBanner: React.FC = () => {
  ...
  return (
    <div className="bg-[#0F3D2E] text-white px-4 py-2 text-xs flex items-center justify-between gap-2 sticky top-0 z-50 animate-in slide-in-from-top duration-300 shadow-md">
