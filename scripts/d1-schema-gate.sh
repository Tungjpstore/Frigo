...
echo "D1 schema gate passed: required migrations (0001-0017 and 0019-0021), security/Week schema, recipe foundation, ranking persistence, and foreign keys are valid."
